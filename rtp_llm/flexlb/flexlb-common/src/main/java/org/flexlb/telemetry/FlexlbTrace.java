 ...
 *
 * <p>Whatever launches the process configures GlobalOpenTelemetry -- the
 * application itself, or an external instrumentation provider. When nothing
 * configures a provider, the global implementation is a no-op and these methods
 * leave scheduling behavior unchanged.</p>
 */
